...
def RequestAddCommandType(builder, commandType): builder.PrependUint8Slot(0, commandType, 0)
def AddCommandType(builder, commandType):
    return RequestAddCommandType(builder, commandType)
def RequestAddCommand(builder, command): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(command), 0)
